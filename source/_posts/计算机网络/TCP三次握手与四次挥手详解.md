...
![这里写图片描述](https://i.loli.net/2020/09/04/CxKqBnRU8VfjmLv.gif)
...
5. 当服务器收到客户端的确认后也进入ESTABLISHED状态，此后双方就可以开始通信了。
   ![三次握手](https://i.loli.net/2020/09/04/B9WVqO3DULcpQxJ.png)



### TCP连接的释放（四次挥手）

![这里写图片描述](https://i.loli.net/2020/09/04/MRzkwCVnKaGd94t.gif)
...
![四次挥手](https://i.loli.net/2020/09/04/4jckDEF81C59HaX.png)
